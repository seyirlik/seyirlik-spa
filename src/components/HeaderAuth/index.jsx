...
const HeaderAuth = () => {
  ...
  return (
    <div
      className={`auth ${url === '/' && !isAuthenticated && 'auth--invisible'}`}
    >
      <a
        href={`${isAuthenticated ? '/u/' + user.nick : '/#giris'}`}
      ...
      >
        ...
        <h3 className="auth__title">
          {isAuthenticated ? user.nick : 'Giriş Yap'}
        </h3>
      </a>
      {isAuthenticated && (
